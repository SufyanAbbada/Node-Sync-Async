...
//should be Printed. But here our Function havent waited but printed the last line and gone.
...
//We also cannot wait for it to complete because that will stop the thread and that thred will now not be available for others to execute.
